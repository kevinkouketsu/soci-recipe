...
from conan.tools.files import apply_conandata_patches, copy, export_conandata_patches, get, rmdir, patch
...
class SociConan(ConanFile):
    ...
    license = "BSL-1.0"
    version = "4.0.3.1"
    exports_sources = "soci/*", "0001-Remove-hardcoded-INSTALL_NAME_DIR-for-relocatable-li.patch"
    ...
    def build(self):
        patch(self, base_path=".", patch_file="0001-Remove-hardcoded-INSTALL_NAME_DIR-for-relocatable-li.patch")
        cmake = CMake(self)
        cmake.configure()
        cmake.build()
